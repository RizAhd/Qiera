  ...
  return (
    <SafeAreaView className="bg-white flex-1">
      ...
      <ScrollView
        ...
        contentContainerStyle={{ paddingBottom: 90 }} // 👈 space for sticky button
      >
        {/* Image */}
...
<TouchableOpacity className="absolute top-4 right-4 rounded-full size-11 items-center justify-center z-50" onPress={handleSave}>
  ...
  />
      ...
      <View className="absolute bottom-0 left-0 right-0 bg-white px-4 py-3 border-t border-gray-200">
        <TouchableOpacity className="w-full h-[52px] bg-blue-950 rounded-xl flex-row items-center justify-center">
